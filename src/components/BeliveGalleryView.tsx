...
const BELIVE_IMAGES = [
  {
    ...
    description: 'Modern, elegant and minimalist beauty brand logo mark'
  },
  {
    url: 'https://raw.githubusercontent.com/Maesroursalah/portfolio/main/beliver/Add_logo_and_QR_code_202608151741.jpeg',
    title: 'Packaging & QR Code Brand Showcase',
    description: 'Cosmetic packaging presentation with QR code and identity integration'
  },
  {
    ...
    title: '2K Product Packaging Mockup',
    description: 'High resolution product presentation & luxury packaging design'
  }
];
        ...
        <div className="space-y-5">
            ...
            <div className="relative aspect-square max-h-[420px] sm:max-h-[460px] w-full mx-auto rounded-2xl overflow-hidden bg-[#120706] flex items-center justify-center">
              ...
              <div className="absolute top-3 left-3 z-20">
                <span className="px-2.5 py-0.5 rounded-full text-[11px] font-mono font-bold bg-[#1B0C0B]/85 text-[#D68379] border border-[#572A26] backdrop-blur-md">
                  0{currentIndex + 1} / 0{BELIVE_IMAGES.length}
                </span>
              </div>
            </div>
          ...
          <div className="max-w-2xl mx-auto space-y-2">
            <div className="flex items-center justify-between text-[11px] font-mono text-rose-300/60 px-1">
              <span>Select Slide ({BELIVE_IMAGES.length} items)</span>
              <span>Slide {currentIndex + 1} of {BELIVE_IMAGES.length}</span>
            </div>
            ...
            <div className="flex items-center gap-2.5 overflow-x-auto pb-2 scrollbar-none snap-x justify-start sm:justify-center">
              {BELIVE_IMAGES.map((img, idx) => (
                <button
                  ...
                  className={`relative flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden transition-all duration-300 snap-start border-2 ${
                    currentIndex === idx
            ...
            <div className="absolute top-4 left-4 right-4 sm:top-6 sm:left-8 sm:right-8 flex items-center justify-between z-10">
              <div className="flex items-center gap-3">
                <span className="text-sm font-serif font-bold text-[#fff8f0]">
                  BELIVE — {BELIVE_IMAGES[currentIndex].title}
                </span>
